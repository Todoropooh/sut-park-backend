...
const Activity = require('../models/activityModel'); // (เราจะสร้างไฟล์นี้)
const fs = require('fs');
const path = require('path');
const mongoose = require('mongoose');

// (ย้ายมาจาก GET /public/activities)
...
// (ย้ายมาจาก GET /api/activities/:id)
...
// (ย้ายมาจาก PUT /api/activities/:id)
...
// (ย้ายมาจาก DELETE /api/activities/:id)
